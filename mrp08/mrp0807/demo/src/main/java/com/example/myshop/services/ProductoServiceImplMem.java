...
import com.example.myshop.exceptions.EmptyProductoListException;
...
public class ProductoServiceImplMem implements ProductoService {
    ...
    public List<Producto> obtenerTodos() {
        ...
        if(lista.isEmpty()) throw new EmptyProductoListException();
        else return productoRepositorio.findAll();
    }
